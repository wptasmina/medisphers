                        ...
                        {doctorsData
                            ...
                            .map((doctor) => (
                                ...
                                >
                                    ...
                                    <p className="text-blue-600 bg-blue-50 p-1">{doctor.department}</p>
                                    <p
                                        className={`text-sm ${doctor.availableStatus === true ? "text-green-500" : "text-red-500"}`}
                                    >
                                        {doctor.availableStatus}
                                    </p>
                                    <p className="text-sm text-gray-500">Age: {doctor.age} years</p>
                                    <p className="text-sm text-gray-500">Experience: {doctor.workExperienceYears} years</p>
